<template>
  <div id="section-header-video" class="header_1NV2O showReminder_Z0Cxe">
    <div class="inner_LVYhi ready_2aiKi">
            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-lg-8">
                <div class="content_OqPHq">
                  <div class="text_3oKnO">Register to receive updates</div>
                  <div class="btn__r4xY">
                    <span>Register</span>
                  </div>
                </div>
                    ...
                    <div class="col-lg-12">
                      <div class="content_LtHlj">
                        ...
                        <div class="d-lg-none d-flex toogle_n8_Tr">
                          ...
                          <svg
                            viewBox="0 0 16 16"
                            class="icon icon--dots icon_2SKlE dots_3GUsn"
                          >
                            <use xlink:href="#dots" />
                          </svg>
                        </div>
      ...
      <div class="d-lg-none d-flex welcome_3G-Y3">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <div class="content_LtHlj">
                    ...
                    <div class="bottom_V0swQ">
                      <div>
                        <div ssr="true" class="quill_3NdfW text_3lCcx">
                          <div
                            class="notranslate quill-text textarea_32Afl ql-container ql-disabled"
                          >
                      ...
                      <div class="buttons_Mmfad" style="display:;">
                        <div class="btn_1jeBI watchBtn_31UAW">
                          ...
                          <svg
                            viewBox="0 0 13 17"
                            class="icon icon--play icon_2SKlE play_F77HD"
                          >
                            <use xlink:href="#play" />
                          </svg>
                        </div>
      ...
      <div id="section-episode-video" class="videoContainer_5zja3">
        <div class="container container_olEqQ">
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="youtube_2K5EL videoBlock_1A2xj">
                <iframe
                  class="player_11CgE"
                  frameborder="0"
                  allowfullscreen="1"
                  ...
                  width="640"
                  height="360"
                  src="https://www.youtube.com/embed/OMOfznp4N38?rel=0&amp;showinfo=0&amp;enablejsapi=1&amp;origin=https%3A%2F%2Fbible.awr.org&amp;widgetid=1"
                  id="widget2"
                ></iframe>
              </div>
            </div>
...
.closeBox_jsrtl:hover .close_ahHRa {
...
.btn__r4xY:active:before,
.btn__r4xY:focus:before,
.btn__r4xY:hover:before {
  opacity: 0.05;
}
.burgerBox_iKUlt {
  width: 70px;
